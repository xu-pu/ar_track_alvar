...
int main(int argc, char* argv[])
{
  try
  {
    ...
    std::cout << "  This is an example of how to use the 'FernImageDetector' "
                 "and"
              << std::endl;
    std::cout << "  'FernPoseEstimator' classes to detect and track an image "
                 "and"
              << std::endl;
    std::cout << "  visualize it using 'GlutViewer'. The classification must "
                 "first"
              << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "  For optimal results, a high quality USB camera or a "
                 "Firewire"
              << std::endl;
    std::cout << "  camera is necessary. It is also advised to calibrate the "
                 "camera"
              << std::endl;
    std::cout << "  using the SampleCamCalib sample. It should be noted that "
                 "the size"
              << std::endl;
    std::cout << "  of the trained image will affect the optimal distance for "
                 "detection."
              << std::endl;
    std::cout << std::endl;
