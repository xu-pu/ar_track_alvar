...
int main(int argc, char* argv[])
{
  try
  {
    ...
    std::cout << "  This is an example of how to use the 'CvTestbed', "
                 "'CaptureFactory' and"
              << std::endl;
    std::cout << "  'Capture' classes. The 'CaptureFactory' can create "
                 "'Capture' objects"
              << std::endl;
    std::cout << "  from many different backends (see SampleCvTestbed.cpp). "
                 "You can also"
              << std::endl;
    std::cout << "  show/hide the 1st ten images created using 'CvTestbed' "
                 "using the number"
              << std::endl;
    std::cout << "  keys. In this example you can use key '0' to show/hide a "
                 "grayscale"
              << std::endl;
