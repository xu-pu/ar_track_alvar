...
struct ALVAR_EXPORT ProjPoints
{
  ...
  bool AddPointsUsingChessboard(IplImage* image, double etalon_square_size, int etalon_rows, int etalon_columns,
                                bool visualize);
...
public:
  ...
  /** \brief Calculate exterior orientation
   */
  void CalcExteriorOrientation(std::vector<CvPoint3D64f>& pw, std::vector<PointDouble>& pi, CvMat* rodriques,
                               CvMat* tra);

  /** \brief Calculate exterior orientation
   */
  void CalcExteriorOrientation(std::vector<PointDouble>& pw, std::vector<PointDouble>& pi, CvMat* rodriques,
                               CvMat* tra);
  ...
  /** \brief Project points
   */
  void ProjectPoints(const CvMat* object_points, const CvMat* rotation_vector, const CvMat* translation_vector,
