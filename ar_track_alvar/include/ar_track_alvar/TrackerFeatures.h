...
public:
   ...
   */
  TrackerFeatures(int _max_features = 100, int _min_features = 90, double _quality_level = 0.01,
                  double _min_distance = 10, int _pyr_levels = 1, int _win_size = 3);
  /** \brief Destructor */
  ~TrackerFeatures();
  /** \brief Change settings while running */
  void ChangeSettings(int _max_features = 100, int _min_features = 90, double _quality_level = 0.01,
